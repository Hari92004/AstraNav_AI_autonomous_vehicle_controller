...
%   Copyright 2024 The MathWorks, Inc.  
    ...
    ONNXShape__ = model3_trajectory_predictor.coder.ops.extractIfDlarray(ONNXShape_);
    allowzero   = coder.const(model3_trajectory_predictor.coder.ops.extractIfDlarray(allowzero_));
