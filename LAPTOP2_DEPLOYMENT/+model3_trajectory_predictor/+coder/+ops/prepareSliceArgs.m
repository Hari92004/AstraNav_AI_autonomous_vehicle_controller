...
Starts = model3_trajectory_predictor.coder.ops.extractIfDlarray(Starts_);
Ends = model3_trajectory_predictor.coder.ops.extractIfDlarray(Ends_);
Axes_ = model3_trajectory_predictor.coder.ops.extractIfDlarray(Axes__);
Steps_ = model3_trajectory_predictor.coder.ops.extractIfDlarray(Steps__);
numDimsX = model3_trajectory_predictor.coder.ops.extractIfDlarray(numDimsX_);
